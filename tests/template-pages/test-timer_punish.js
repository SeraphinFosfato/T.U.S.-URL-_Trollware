// Test page for timer_punish
const express = require('express');
const app = express();

app.get('/', (req, res) => {
  const testData = {
  "templateId": "timer_punish",
  "params": {
    "duration": 25
  },
  "targetUrl": "https://example.com",
  "fingerprint": "test-timer_punish",
  "step": 1,
  "totalSteps": 1
};
...
<body>
  <div class="test-info">
    <h2>Testing Template: timer_punish</h2>
  ...
  <div class="template-container">
    <div id="game-container">
      ...
      <p>Loading timer_punish template...</p>
    </div>
  </div>
  ...
  <script>
    ...
    document.getElementById('game-container').innerHTML = 
      '<p>Template timer_punish loaded with params: ' + 
...
app.listen(PORT, () => {
  console.log(`timer_punish test server running on http://localhost:${PORT}`);
});
