// Test page for timer_then_click
const express = require('express');
const app = express();

app.get('/', (req, res) => {
  const testData = {
  "templateId": "timer_then_click",
  "params": {
    "totalTime": 60,
    "timerRatio": 0.6
  },
  "targetUrl": "https://example.com",
  "fingerprint": "test-timer_then_click",
  "step": 1,
  "totalSteps": 1
};
...
<html>
<head>
  <title>Test timer_then_click</title>
  <style>
...
<body>
  <div class="test-info">
    <h2>Testing Template: timer_then_click</h2>
  ...
  <div class="template-container">
    <div id="game-container">
      ...
      <p>Loading timer_then_click template...</p>
    </div>
  </div>
  ...
  <script>
    ...
    document.getElementById('game-container').innerHTML = 
      '<p>Template timer_then_click loaded with params: ' + 
...
app.listen(PORT, () => {
  console.log(`timer_then_click test server running on http://localhost:${PORT}`);
});
