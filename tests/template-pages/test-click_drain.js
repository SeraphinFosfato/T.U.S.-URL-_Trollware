// Test page for click_drain
const express = require('express');
const app = express();

app.get('/', (req, res) => {
  const testData = {
  "templateId": "click_drain",
  "params": {
    "clicks": 20
  },
  "targetUrl": "https://example.com",
  "fingerprint": "test-click_drain",
  "step": 1,
  "totalSteps": 1
};
...
<body>
  <div class="test-info">
    <h2>Testing Template: click_drain</h2>
  ...
  <div class="template-container">
    <div id="game-container">
      ...
      <p>Loading click_drain template...</p>
    </div>
  </div>
  ...
  <script>
    ...
    document.getElementById('game-container').innerHTML = 
      '<p>Template click_drain loaded with params: ' + 
...
app.listen(PORT, () => {
  console.log(`click_drain test server running on http://localhost:${PORT}`);
});
